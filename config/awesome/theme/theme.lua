...
-- Weather
theme.ic_weather_clear_day = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_clear_day.svg")
theme.ic_weather_clear_night = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_clear_night.svg")
theme.ic_weather_cloudy = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_cloudy.svg")
theme.ic_weather_drizzle = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_drizzle.svg")
theme.ic_weather_fog = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_fog.svg")
theme.ic_weather_haze_day = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_haze_day.svg")
theme.ic_weather_haze_night = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_haze_night.svg")
theme.ic_weather_hot = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_hot.svg")
theme.ic_weather_overcast = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_overcast.svg")
theme.ic_weather_overcast_day = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_overcast_day.svg")
theme.ic_weather_overcast_day_snow = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_overcast_day_snow.svg")
theme.ic_weather_overcast_night = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_overcast_night.svg")
theme.ic_weather_overcast_night_rain = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_overcast_night_rain.svg")
theme.ic_weather_overcast_night_snow = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_overcast_night_snow.svg")
theme.ic_weather_partly_cloudy_day = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_partly_cloudy_day.svg")
theme.ic_weather_partly_cloudy_day_drizzle = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_partly_cloudy_day_drizzle.svg")
theme.ic_weather_partly_cloudy_day_rain = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_partly_cloudy_day_rain.svg")
theme.ic_weather_partly_cloudy_day_snow = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_partly_cloudy_day_snow.svg")
theme.ic_weather_partly_cloudy_night = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_partly_cloudy_night.svg")
theme.ic_weather_partly_cloudy_night_rain = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_partly_cloudy_night_rain.svg")
theme.ic_weather_partly_cloudy_night_snow = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_partly_cloudy_night_snow.svg")
theme.ic_weather_partly_cloudy_night_thunderstorms = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_partly_cloudy_night_thunderstorms.svg")
theme.ic_weather_rain = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_rain.svg")
theme.ic_weather_rain_snow = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_rain_snow.svg")
theme.ic_weather_severe_cold = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_severe_cold.svg")
theme.ic_weather_sleet = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_sleet.svg")
theme.ic_weather_snow = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_snow.svg")
theme.ic_weather_thunderstorms = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_thunderstorms.svg")
theme.ic_weather_thunderstorms_day = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_thunderstorms_day.svg")
theme.ic_weather_thunderstorms_night = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_thunderstorms_night.svg")
theme.ic_weather_wind = gears.surface.load_uncached(gfs.get_configuration_dir() .. "theme/assets/icons/weather/ic_weather_wind.svg")
